...
def main(args):
    ...
    if args.model_type == 'caffe':
        ...
        #read_image_func = lambda img: (cv2.cvtColor(cv2.imread(img).astype('float32'), cv2.COLOR_BGR2RGB) - 127.5) * 0.0078125
...
def parse_arguments(argv):
    ...
    parser.add_argument('--model', type=str,
                        ...
                        default='models/BinaryDenseNet28/binarydensenet28_FT_scface_50/'
                                'binarydensenet28_FT_scface_50_lr_112x112_folders_basic_lfw_14_hr2lr_interArea_epoch_1_binary_0.781333.h5')
    ...
    parser.add_argument('--eval_db_path', default='/datasets/',
    ...
    parser.add_argument('--feat_name', type=str, help='feature_name for the database',
                        default='binarydensenet28_FT_scface.txt')
