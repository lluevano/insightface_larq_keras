...
data_path = '/media/lusantlueg/WORK_CVLAB2/insightface_larq_keras/datasets/ms1m-retinaface-t1'
eval_paths = ['/media/lusantlueg/WORK_CVLAB2/insightface_larq_keras/datasets/ms1m-retinaface-t1/lfw.bin', '/media/lusantlueg/WORK_CVLAB2/insightface_larq_keras/datasets/ms1m-retinaface-t1/cfp_fp.bin', '/media/lusantlueg/WORK_CVLAB2/insightface_larq_keras/datasets/ms1m-retinaface-t1/agedb_30.bin']

tt = train.Train(data_path, save_path='2_keras_binaryfacenet_retina.h5', eval_paths=eval_paths,
